...
typedef struct otPosixRadioOperations
{
     ...
     *
     */
    otError (*DiagProcess)(otPosixRadioInstance *aInstance, const char *aString, char *aOutput, size_t aOutputMaxLen);
     ...
     *
     */
    otError (*ExtendedAddressSet)(otPosixRadioInstance *aInstance, const otExtAddress *aAddress);
     ...
     *
     */
    otError (*IeeeEui64Get)(otPosixRadioInstance *aInstance, uint8_t *aIeeeEui64);
     ...
     *
     */
    otError (*PanIdSet)(otPosixRadioInstance *aInstance, uint16_t aPanId);
     ...
     *
     */
    otError (*PromiscuousSet)(otPosixRadioInstance *aInstance, bool aEnable);
     ...
     *
     */
    otRadioCaps (*RadioCapsGet)(otPosixRadioInstance *aInstance);
     ...
     *
     */
    otError (*RadioDisable)(otPosixRadioInstance *aInstance);
     ...
     *
     */
    otError (*RadioEnable)(otPosixRadioInstance *aInstance);
     ...
     *
     */
    otError (*RadioReceive)(otPosixRadioInstance *aInstance, uint8_t aChannel);
     ...
     *
     */
    otError (*RadioSleep)(otPosixRadioInstance *aInstance);
     ...
     */
    otError (*RadioTransmit)(otPosixRadioInstance *aInstance, otRadioFrame *aFrame);
     ...
     *
     */
    otError (*ShortAddressSet)(otPosixRadioInstance *aInstance, uint16_t aShortAddress);
     ...
     *
     */
    otError (*SrcMatchEnable)(otPosixRadioInstance *aInstance, bool aEnable);
     ...
     *
     */
    otError (*SrcMatchExtEntriesClear)(otPosixRadioInstance *aInstance);
     ...
     *
     */
    otError (*SrcMatchShortEntriesClear)(otPosixRadioInstance *aInstance);
...
extern otError otPosixRadioDriverRegister(otPosixRadioDriver *aDriver, void *aContext);
