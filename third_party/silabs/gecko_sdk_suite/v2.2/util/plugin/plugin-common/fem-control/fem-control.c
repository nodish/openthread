...
#include "em_cmu.h"
  ...
  || !defined(BSP_FEM_SLEEP_PORT)    \
  || !defined(BSP_FEM_SLEEP_PIN)     \
  || !defined(BSP_FEM_SLEEP_LOC)     \
  || !defined(BSP_FEM_RX_CHANNEL)    \
  || !defined(BSP_FEM_RX_PORT)       \
  || !defined(BSP_FEM_RX_PIN)        \
  || !defined(BSP_FEM_RX_LOC))
  #error "BSP_FEM_SLEEP_CHANNEL/PORT/PIN/LOC and BSP_FEM_RX_CHANNEL/PORT/PIN/LOC must be defined."
#endif
...
#if BSP_FEM_SLEEP_CHANNEL >= PRS_CHAN_COUNT
