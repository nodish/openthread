...
void halHostSerialPowerup(void)
{
  ...
  nWAKE_INTCFG = (EVENT_GPIO_CFGx_MOD_DISABLED << _EVENT_GPIO_CFGA_MOD_SHIFT);
  //Configure nWAKE pin
  ...
  nWAKE_INTCFG =  (0 << _EVENT_GPIO_CFGA_FILT_SHIFT)       //no filter
                 | (EVENT_GPIO_CFGx_MOD_FALLING_EDGE << _EVENT_GPIO_CFGA_MOD_SHIFT);
  ...
  nSSEL_INTCFG = (EVENT_GPIO_CFGx_MOD_DISABLED << _EVENT_GPIO_CFGA_MOD_SHIFT);
  ...
  nSSEL_INTCFG = (0 << _EVENT_GPIO_CFGA_FILT_SHIFT)      //no filter
                 | (EVENT_GPIO_CFGx_MOD_RISING_EDGE << _EVENT_GPIO_CFGA_MOD_SHIFT);
  ...
  nSIMRST_INTCFG = (EVENT_GPIO_CFGx_MOD_DISABLED << _EVENT_GPIO_CFGA_MOD_SHIFT);
