...
#define EVENT_GPIO_CFGx_MOD_DISABLED      (0x0U)
#define EVENT_GPIO_CFGx_MOD_RISING_EDGE   (0x1U)
#define EVENT_GPIO_CFGx_MOD_FALLING_EDGE  (0x2U)
#define EVENT_GPIO_CFGx_MOD_BOTH_EDGES    (0x3U)
#define EVENT_GPIO_CFGx_MOD_HIGH_LEVEL    (0x4U)
#define EVENT_GPIO_CFGx_MOD_LOW_LEVEL     (0x5U)
