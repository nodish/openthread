...
import efm32pg13b.modules.PIN.PIN_Snippets as PIN_Snippets
import efm32pg13b.modules.PORTIO.PORTIO_Snippets as PORTIO_Snippets
import efm32pg13b.halconfig.halconfig_dependency as dep

import efm32pg13b.modules.ACMP0.ACMP_behavior as ACMP_behavior
import efm32pg13b.modules.ACMP1.ACMP_behavior as ACMP_behavior
import efm32pg13b.modules.ADC0.ADC_behavior as ADC_behavior
...
import efm32pg13b.modules.CSEN.CSEN_behavior as CSEN_behavior
...
import efm32pg13b.modules.IDAC0.IDAC_behavior as IDAC_behavior
...
import efm32pg13b.modules.VDAC0.VDAC_behavior as VDAC_behavior
import efm32pg13b.modules.WDOG.WDOG_behavior as WDOG_behavior
import efm32pg13b.upgrade as upgrade
import efm32pg13b.upgrade.upgradeDispatch as upgradeDispatch
PROFILE = True

@RuntimeModel.bind_document_upgrade
def onUpgrade(event, xmlDevice):
    print("Triggering upgrade")
    (newXmlDevice, changeText) = upgradeDispatch.upgradeMain(upgrade, xmlDevice)
    evs = []
