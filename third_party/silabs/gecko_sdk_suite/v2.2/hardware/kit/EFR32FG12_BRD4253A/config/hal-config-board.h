...
#define PORTIO_GPIO_TCLK_PIN                          (8U)
#define PORTIO_GPIO_TCLK_PORT                         (gpioPortF)
#define PORTIO_GPIO_TCLK_LOC                          (0U)

#define PORTIO_GPIO_TD0_PIN                           (9U)
#define PORTIO_GPIO_TD0_PORT                          (gpioPortF)
#define PORTIO_GPIO_TD0_LOC                           (0U)

#define PORTIO_GPIO_TD1_PIN                           (10U)
#define PORTIO_GPIO_TD1_PORT                          (gpioPortF)
#define PORTIO_GPIO_TD1_LOC                           (0U)

#define PORTIO_GPIO_TD2_PIN                           (11U)
#define PORTIO_GPIO_TD2_PORT                          (gpioPortF)
#define PORTIO_GPIO_TD2_LOC                           (0U)

#define PORTIO_GPIO_TD3_PIN                           (12U)
#define PORTIO_GPIO_TD3_PORT                          (gpioPortF)
#define PORTIO_GPIO_TD3_LOC                           (0U)
